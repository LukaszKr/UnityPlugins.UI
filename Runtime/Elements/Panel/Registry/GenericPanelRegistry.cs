...
{
	[CreateAssetMenu(fileName = nameof(GenericPanelRegistry), menuName = UIConsts.MENU_ROOT+nameof(GenericPanelRegistry))]
	public class GenericPanelRegistry: ScriptableObject, IPanelRegistry
	{
		[SerializeField]
